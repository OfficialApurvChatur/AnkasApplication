...
const StaticDataModel = require("../../aModel/dAsset/aStaticDataModel")
...
exports.staticDataController = (Model= StaticDataModel, Label= 'Static Data', Cache= 'staticDataController') => {
	return {
		// List Controller
